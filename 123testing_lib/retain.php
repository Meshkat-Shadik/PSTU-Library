...
<body>
	...
	<p style="font-size: 30px;color: white;text-align: center;margin-top: 4%;"><u>All student's list</u></p>
	<div class="container">
		<div class="row">
		...
		?>
				...
				<table class="table borderd-table">
					<tr style="background-color: #CAEEFF;">
						...
						<th>Retain Date</th>
						<!-- <th>Quantity</th> -->
						<th colspan="2">Message Him/Her</th>
						<!-- <th>Fees</th> -->
					</tr>
					<?php 
					...
					<tr>
						...
						<form action="retain_db.php" method="POST">
						<input type="checkbox" id="finRot" name="something" value=<?php echo $row->sid?> >
						<br>
						<label style="color: white;">Today:</label> <input type="date" name="dt1" class="form-control">
