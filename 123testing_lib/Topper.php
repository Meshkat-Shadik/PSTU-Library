...
<body data-spy="scroll" data-target=".navbar">
	<nav class="navbar navbar-inverse navbar-fixed-top" id="nav-top">
		...
		<li><a href="#bookk" class="menu_link-scroll"><span class="fa fa-book" style="margin-left: 12px;"></span><br>Books</a>
			...
			<li><form><a href="admincheck.php" style="color: #8A8A8A"><span class="fa fa-user-circle-o" style="margin-left: 11px; margin-top: 19px;color: #8A8A8A"></span><br>Admin</a></form>
...
$result = mysqli_query($conn,$query);
 while($row = mysqli_fetch_object($result))
            { 
               echo'<marquee style="color: #000;" bgcolor="#D9ECFF" scrolldelay="200" behavior="alternate"><h4><i>'.$row->Msg.'</i></h4></marquee>';
            }
?>
<!-- <marquee>sdlkajhdas</marquee> -->
           ...
           <div class="row">
               ...
               <div class="col-md-3">
                   <div class="single-pricing-box">
                       ...
                       <a href="war.php" class="bordered-btn">Visit</a>
                   </div>
               </div>
               <div class="col-md-3">
                   <div class="single-pricing-box">
                       ...
                       <a href="other.php" class="bordered-btn">Visit</a>
                   </div>
               </div>
           </div>
       </div>
 ...
 <div class="container" style=" margin-top: 50px ;border: 1px dashed #BFBFBF;box-shadow:  0 0 10px #BFBFBF; ;padding-left: 25px; padding-right: 25px">
	...
	<div id='a_us' class="container-fluid content-padding">
		<div class="row">
			...
			<div class="col-sm-2">
				<img class="img-responsive" id="height-weight" src="img/man.png" style="margin-top: 50px">
			</div>
			<div class="col-sm-10">
				<h4><strong>Mr.X</strong></h4>
				<p class="text-justify">Welcome! On behalf of the staff of PSTU Library, I’m pleased to invite you to take advantage of everything the Library has to offer.</p>
            ...
            <p class="text-justify">
                You don’t have to take my word for it: PSTU’s graduating seniors consistently rate the Library the No. 1 service on campus. Faculty members rank the Library as the most satisfying aspect of their work life, contributing to research breakthroughs.
            </p>
            <p class="text-justify">
                Librarians are experts in the tools of 21st century scholarship, and can help PSTUians save time and enhance their research with innovative methods. Our work in digitization, preservation, open access and fair use makes information more accessible and broadens PSTU’s reach. Library partnerships and programs expand international access to information, advancing PSTU’s land-grant mission and helping to create positive change through the spread of knowledge around the world.
            </p>
            <p class="text-justify">
	...
	<div id='c_us' class="container-fluid contact-us content-padding">
        ...
        <form method="POST" action="feedback.php">
				...
				<div class="form-group col-sm-6">
					...
					<textarea  class="form-group form-control"cols="30" rows="5" placeholder="Text" name="texts"></textarea>
					<input  class="btn btn-primary pull-right" type="Submit" name="SubmitButton" value="Submit" style="text-align: center">
			</div>
    </form>
    <?php
...
//      // $mail->SetFrom =''
//       $mail->setFrom('unknown1602058@gmail.com', 'PSTU Library');
//       $mail->Subject = 'Hello World!';
//        $mail->Body = 'a test mail';
//        $mail->AddAddress('catshadik@gmail.com');
//         $mail->Send();
