...
<html>
    ...
    <body>
        <h2 style="color:black;font-family: fantasy;text-align: center;background: beige;box-shadow: 0 15px 25px rgba(255,255,255,0.5);">Poems</h2>
        <hr>
        <nav>
            <ul>
      ...
      $conn = mysqli_connect('localhost','root','','img_show');
            $result = mysqli_query($conn,"select * from book_datas where genre='Poem';");
